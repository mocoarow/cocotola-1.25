...
func initApp(ctx context.Context, _ authdomain.SystemToken, dbConn *libgateway.DBConnection) (authservice.TransactionManager, authservice.TransactionManager, error) {
