...
type AttachPolicyToUserBySystemAdminFunc func(ctx context.Context, operator domain.SystemAdminInterface, organizationID *domain.OrganizationID, subject libdomain.RBACSubject, action libdomain.RBACAction, object libdomain.RBACObjectInterface, effect libdomain.RBACEffect) error

type AttachPolicyToUserBySystemOwnerFunc func(ctx context.Context, operator domain.SystemOwnerInterface, subject libdomain.RBACSubject, action libdomain.RBACAction, object libdomain.RBACObjectInterface, effect libdomain.RBACEffect) error
...
type AttachPolicyToUserFunc func(ctx context.Context, operator domain.UserInterface, subject libdomain.RBACSubject, action libdomain.RBACAction, object libdomain.RBACObjectInterface, effect libdomain.RBACEffect) error
