...
type AttachPolicyToUserBySystemAdminFunc func(ctx context.Context, operator domain.SystemAdminInterface, organizationID *domain.OrganizationID, subject libdomain.RBACSubject, action libdomain.RBACActionInterface, object libdomain.RBACObjectInterface, effect libdomain.RBACEffectInterface) error

type AttachPolicyToUserBySystemOwnerFunc func(ctx context.Context, operator domain.SystemOwnerInterface, subject libdomain.RBACSubject, action libdomain.RBACActionInterface, object libdomain.RBACObjectInterface, effect libdomain.RBACEffectInterface) error
...
type AttachPolicyToUserFunc func(ctx context.Context, operator domain.UserInterface, subject libdomain.RBACSubject, action libdomain.RBACActionInterface, object libdomain.RBACObjectInterface, effect libdomain.RBACEffectInterface) error
